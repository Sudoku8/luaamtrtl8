...
--	local i2 = init.mwbtnid..".cl"
	local v  = getBtnInfo("dockarea")
	local x  = v.w
--	systween{ id=(ix), x=("0,"..x), time=(tm) }
	systween{ id=(ix), y="0,40" , time=(tm) }
...
function notification()
	...
	local func = function(md, nm, v)
		...
		if r then
			...
			tween{id=(id), alpha="255,0", time=(tm), delay="5000"}
